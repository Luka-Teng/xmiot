...
interface Reply {
  (code: number, response: any, options?: {
    delay?: number
    errorMessage?: string
  }): Net
}
...
declare class Net {
  ...
  public postSuccess: (callback: (response: genObject, stop: Function) => any) => Net

  /* net.postError((error, stop) => {}) */
  public postError: (callback: (error: genObject, stop: Function) => any) => Net

  /* net.onCache */
  public onCache: (options: {
    url: string
    method: string
    timeout: number
    ignoreParams: string[]
  ...
  /* net.prevent */
  public prevent: (options: {
    ignores: string[]
  }) => void

  /* net.onResend */
  public onResend: (options: {
    url: string,
    method: string,
    times: number
  }) => void
